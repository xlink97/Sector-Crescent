...
game-ticker-player-join-game-message = Welcome to Hullrot.
game-ticker-get-info-text = Welcome to [color=white]Hullrot[/color].
                            The current Story ID is: [color=white]#{$roundId}[/color]
